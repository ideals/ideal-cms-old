...
$(function () {
    $("input:password").bind("input", function () {
        let password = "#general_password";
        let password_check = "#general_password-check";
        let password_group = "#general_password-control-group";
        let password_ico = "#general_password-ico";
